...
catImg.setAttribute('src', 'https://tenor.com/StFI.gif')
console.log(catImg);
...
function catWalk(){
	catValue +=10;
	catImg.style.left = catValue + "px";
	// if (catValue > window.innerWidth / 2){
	// 	catValue = window.innerWidth / 2;
	// 	catImg.setAttribute('src', 'https: //tenor.com/StFI.gif');
	// }
...
//side("0px").So they should keep walking from left to right across the screen, 
//forever and ever.
	if (catValue > window.innerWidth){//here I dont understand why it doesnt work if catValue > window.innerWidth
		catValue = 0;
	}
	}
